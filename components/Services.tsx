...
const Services: React.FC = () => {
  const services = [
    ...
    },
    {
      ...
      list: ["Heat & aging treatment", "CNC machining & finishing", "Coating, polishing, sand-blasting"]
    },
    {
      icon: <Truck size={32} />,
  ...
  const matrixData = [
    ...
    { cap: "Plastic 3D Printing", proto: true, small: true, med: false, support: "Design Review" },
    { cap: "Post-Processing", proto: true, small: true, med: true, support: "Process Matching" },
    { cap: "CNC Machining", proto: false, small: true, med: true, support: "Tolerance Control" },
